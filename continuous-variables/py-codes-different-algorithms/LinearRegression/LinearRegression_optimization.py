...
for i in range(2,11):
    ...
    with open('Records of Kfold for LinearRegression.txt', 'a') as f:
    ...
    feat_imp = pd.DataFrame(model2.coef_, index=['nap', '2meth', 'Ligan2Metal', 'Cat', 'base', 'i_PrOH', 'Time', 'Temperature', 'concentration'], columns=['Feature_importances'])
    # feat_imp
